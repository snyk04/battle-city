...
namespace BattleCity.GameLoop
{
    public class EnemySpawner : ITankSpawner
    {
        ...
        private readonly FieldPathfinderHelper _fieldPathfinderHelper;
        ...
        public EnemySpawner(IReadOnlyCollection<GameObject> enemyPrefabs, IEnumerable<Vector3> spawnPoints,
            ...
            FieldPathfinderHelper fieldPathfinderHelper, Transform @base)
        {
            ...
            _fieldPathfinderHelper = fieldPathfinderHelper;
            _base = @base;
        ...
        private void SpawnNewEnemy()
        {
            ...
            enemyBotComponent.Initialize(_playerTracker, _fieldPathfinderHelper, _base);
